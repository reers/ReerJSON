...
extension JSONEncoderTests {
    ...
    @Test func json5Numbers() {
        ...
        let successfulDoubles: [(String,Double)] = [
            ...
            // ⚠️⚠️⚠️⚠️⚠️⚠️⚠️ This is different from Apple Foundation implementation,
            // yyjson's YYJSON_READ_ALLOW_INF_AND_NAN support case-insensitive and the short of "Infinity"
            ("-Inf", -Double.infinity),
            ("-Inf       ", -Double.infinity),
            ("+Inf", Double.infinity),
            ("+Inf       ", Double.infinity),
